    ...
    public class RegisterCompanyModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                ...
                if (Empresa.ProvinciaId.HasValue)
                    content.Add(new StringContent(Empresa.ProvinciaId.Value.ToString()), "ProvinciaId");

                if (Empresa.MunicipioId.HasValue)
                    content.Add(new StringContent(Empresa.MunicipioId.Value.ToString()), "MunicipioId");
                ...
                ErrorMessage = "No se pudo registrar la empresa. Por favor intente nuevamente.";
            }
            catch (Exception ex)
            {
